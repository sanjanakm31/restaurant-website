...
?>
	...
	<!-- ABOUT SECTION -->
<section id="about" class="about-section" style="padding: 100px 0; background-color:rgb(233, 225, 225);">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="Design/images/about-restaurant.jpg" alt="About Us" style="width: 100%; border-radius: 10px;">
            </div>
            <div class="col-md-6">
                <h2>About Us</h2>
                <p>Welcome to <b>Vincent Pizza</b>, your go-to place for delicious and freshly prepared meals.</p>
                <p>We take pride in using the best ingredients to create mouth-watering dishes that leave a lasting impression.</p>
                <p>From traditional favorites to innovative new dishes, our chefs bring passion and creativity to every plate.</p>
                <p><b>Join us for a cozy, delightful dining experience!</b></p>
                
                <!-- CONTACT DETAILS -->
                <h3>Contact Information</h3>
                <p><b>Phone:</b> <?php echo $restaurant_phonenumber; ?></p>
                <p><b>Email:</b> <?php echo $restaurant_email; ?></p>
                <p><b>Address:</b> <?php echo $restaurant_address; ?></p>

                <!-- OPENING HOURS -->
                <h3>Opening Hours</h3>
                <p>Monday - Friday: 11:30 AM - 2:00 PM</p>
            </div>
        </div>
    </div>
</section>
