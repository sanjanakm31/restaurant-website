								...
								<div class="items_tab">
				        			<?php
				        				if (isset($category['category_id']) && !empty($category['category_id'])) {
                                            ...
                                            if ($rows) {
                                                // The menu items exist, process them normally
                                            } else {
                                                echo "<div style='color: red; font-size: 18px;'>No menus found for this category.</div>";
                                            }
                                        } else {
                                            echo "<div style='color: red; font-size: 18px;'>Error: Category ID is missing.</div>";
                                        }
